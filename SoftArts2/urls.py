...
urlpatterns = [
                  ...
                  url(r'^artworks/(?P<artwork_id>\d+)/like', artwork_like, name='artwork_like'),
                  url(r'^artworks/(?P<artwork_id>\d+)/unlike', artwork_unlike, name='artwork_unlike'),
                  url(r'^artworks/(?P<artwork_id>\d+)/checklike', artwork_like_check, name='artwork_like_check'),
                  url(r'^artworks/(?P<artwork_id>\d+)', artwork_page, name='artwork'),
                  url(r'^users/(?P<user_id>\d+)/update', user_update, name='user_update'),
                  url(r'^users/(?P<user_id>\d+)/checkfollow', user_follow_check, name='user_update'),
                  url(r'^users/(?P<user_id>\d+)/follow', user_follow, name='user_follow'),
                  url(r'^users/(?P<user_id>\d+)/unfollow', user_unfollow, name='user_unfollow'),
